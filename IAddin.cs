namespace VersaNote.Interop
{
    public interface IAddin
    {
        ...
        AddCustomNoteResult AddCustomNote(int sheetIndex, string noteText, int noteIndex = -1, bool subNote = false, string parentId = "", bool suppressTableRefresh = false, bool toogleLinkNote = false);
        ...
        UpdatedCustomNoteResult UpdateCustomNote(int sheetIndex, string noteId, string newNoteText, bool toggleSubNote = false, bool suppressTableRefresh = false, bool toogleLinkNote = false);
    }
}